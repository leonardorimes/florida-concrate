  ...
  return (
    <section className="details-section">
      <div className="details-section__head">
        ...
        <h2>Restore and Protect Your Concrete Surfaces</h2>
        <p>Cracked, worn, or damaged concrete doesn’t just look bad, it can get worse over time if it’s not properly addressed. At Florida Concrete Coating, we provide concrete repair and sealing services that help restore the surface and prevent further damage. We take the time to assess the condition of your concrete, repair problem areas, and apply protective sealers that help defend against moisture, stains, and everyday wear.</p>
      </div>

      <div className="details-section__grid">
        <div className="details-section__image-wrap">
          <img width="800" height="600" loading="lazy" src="/FL%20CONCRETE/tmp9c5ugqjn.jpg" alt="Concrete surface after repair and sealing" />
        </div>
        <div className="details-section__features">
          <ul>
            <li><CheckIcon /> Fixes cracks, spalling &amp; surface damage</li>
            <li><CheckIcon /> Protects against water &amp; UV rays</li>
            <li><CheckIcon /> Enhances the appearance of your surfaces</li>
            <li><CheckIcon /> Prolongs the life of your concrete</li>
            <li><CheckIcon /> Ideal for driveways, patios &amp; walkways</li>
          </ul>
    ...
    <section className="recent-works">
      ...
      <div className="recent-works__inner">
        ...
        <div className="recent-works__action">
          <a href="/contactus" className="btn-secondary">Get a free estimate</a>
        </div>
      </div>
    </section>
  );
