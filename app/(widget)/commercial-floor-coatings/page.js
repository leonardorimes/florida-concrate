...
function HeroInternal() {
  return (
    <section className="hero-internal" style={{ backgroundImage: "url('/FL%20CONCRETE/IMG_2880.jpg')" }}>
      <div className="hero-internal__overlay"></div>
      <div className="hero-internal__content">
        <h1>Commercial Floor Coatings in<br/>Central Florida</h1>
        <p>Durable, professional-grade flooring solutions designed for warehouses, retail spaces, and high-traffic commercial environments.</p>
      </div>
    </section>
  );
}
  ...
  return (
    <section className="details-section">
      <div className="details-section__head">
        ...
        <h2>Flooring Solutions Built for High-Traffic Spaces</h2>
        <p>Commercial floors take constant abuse, from foot traffic and equipment to spills and daily operations. Standard concrete surfaces can wear down quickly without the right protection.</p>
        <p>At Florida Concrete Coating, we install high-performance floor coatings designed for commercial environments. Our systems help improve durability, simplify maintenance, and create a cleaner, more professional appearance for your space.</p>
      </div>

      <div className="details-section__grid">
        <div className="details-section__image-wrap">
          <img width="800" height="600" loading="lazy" src="/FL%20CONCRETE/tmptg7mwurx.jpg" alt="Commercial flooring project" />
        </div>
        <div className="details-section__features">
          <ul>
            <li><CheckIcon /> Built for heavy foot traffic and equipment use</li>
            <li><CheckIcon /> Resistant to stains, chemicals, and surface damage</li>
            <li><CheckIcon /> Easy-to-clean, low-maintenance finishes</li>
            <li><CheckIcon /> Textured options available for added traction</li>
            <li><CheckIcon /> Efficient installation with minimal disruption</li>
          </ul>
