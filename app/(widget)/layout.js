...
export default function WidgetLayout({ children }) {
  return (
    <>
      ...
      <script dangerouslySetInnerHTML={{ __html: `</script><script src="https://widgets.leadconnectorhq.com/loader.js" data-resources-url="https://widgets.leadconnectorhq.com/chat-widget/loader.js" data-widget-id="6a39497ecab3f1c1716ac3e8" data-source="WEB_USER"></script><script>` }} />
      {/* Also keep the actual loading script for real users */}
      <script 
