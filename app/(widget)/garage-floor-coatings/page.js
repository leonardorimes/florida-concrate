    ...
    <section className="details-section">
      ...
      <div className="details-section__grid">
        <div className="details-section__image-wrap">
          <img width="800" height="600" loading="lazy" src="/double_garage_floor.jpg" alt="Garage floor after coating" />
        </div>
        <div className="details-section__features">
          <ul>
            <li><CheckIcon /> 100% UV stable &amp; polyaspartic topcoat formulation</li>
            <li><CheckIcon /> Resistant to hot tires, chemicals &amp; heavy equipment</li>
            <li><CheckIcon /> Easy to clean &amp; maintain for enhanced safety</li>
            <li><CheckIcon /> Quick, 1-day installation (in most applications)</li>
            <li><CheckIcon /> Comes with a product warranty against peeling and flaking</li>
          </ul>
