  ...
  return (
    <section className="hero-internal" style={{ backgroundImage: "none", backgroundColor: "var(--teal)", overflow: "hidden" }}>
      ...
      <div className="hero-internal__content">
        <h1>Concrete Coating Services<br/>in The Villages, FL</h1>
        <p>Durable, slip-resistant coatings for homes in The Villages, installed by experienced local professionals you can trust.</p>
      </div>
    </section>
  );
}
...
export default function TheVillagesPage() {
  return (
    <main>
      ...
      <ReviewsSection className="reviews reviews--white" city="The Villages" />
      <CTASection />
      <Footer />
    </main>
  );
