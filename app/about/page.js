  ...
  return (
    <section className="hero-internal" style={{ backgroundImage: "none", backgroundColor: "var(--teal)", overflow: "hidden" }}>
      ...
      <div className="hero-internal__content">
        <h1>About Florida Concrete<br/>Coating</h1>
        <p>Trusted concrete coating specialists delivering durable, high-quality results for homes across Central Florida.</p>
      </div>
    </section>
  );
}
    ...
    <section className="details-section details-section--white" style={{ background: "#fff", padding: "80px 24px", borderRadius: "0 0 60px 60px" }}>
      <div className="details-section__grid" style={{ maxWidth: "1200px", margin: "0 auto", gap: "60px", gridTemplateColumns: "1fr 1fr", alignItems: "center", display: "grid" }}>
        <div className="details-section__content">
          ...
          <h2 style={{ fontSize: "36px", marginBottom: "20px", color: "var(--teal)" }}>Built on Quality Work and Honest Service</h2>
          <p style={{ marginBottom: "20px", color: "#555", lineHeight: "1.6" }}>With over 3 years of hands-on experience in concrete coatings, we've built our reputation on quality, reliability, and results that last. In 2023, my wife and I started this company with one goal: to deliver top-tier coatings without cutting corners.</p>
          <p style={{ marginBottom: "20px", color: "#555", lineHeight: "1.6" }}>We focus on the details that matter, from proper surface preparation to a flawless finish. Every project is completed with precision to ensure a durable, long-lasting result.</p>
