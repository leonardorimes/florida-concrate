  ...
  return (
    <section className="hero-internal" style={{ backgroundImage: "none", backgroundColor: "var(--teal)", overflow: "hidden" }}>
      ...
      <div className="hero-internal__content">
        <h1>Concrete Coating Services<br/>in Champions Gate, FL</h1>
        <p>Durable, slip-resistant coatings for homes in Champions Gate, installed by experienced local professionals you can trust.</p>
      </div>
    </section>
  );
}
    ...
    <section className="details-section details-section--white" style={{ background: "#fff", padding: "80px 24px" }}>
      <div className="details-section__grid" style={{ maxWidth: "1200px", margin: "0 auto", gap: "60px", gridTemplateColumns: "1fr 1fr", alignItems: "center", display: "grid" }}>
        <div className="details-section__content">
          ...
          <h2 style={{ fontSize: "36px", marginBottom: "20px", color: "var(--teal)" }}>Your Trusted Concrete Coating Experts in Champions Gate</h2>
          <p style={{ marginBottom: "20px", color: "#555", lineHeight: "1.6" }}>We proudly provide professional concrete coating services throughout Champions Gate and surrounding communities. Whether you're upgrading your garage, enhancing your pool deck, or protecting your driveway, our team delivers long-lasting results built for Florida's heat, humidity, and daily wear.</p>
          <p style={{ marginBottom: "30px", color: "#555", lineHeight: "1.6" }}>Our coatings are designed to resist moisture, prevent cracking, and maintain their appearance for years—giving your surfaces a clean, durable, and low-maintenance finish.</p>
          <a href="#quote" className="btn-primary">Get Free Estimate</a>
        </div>
        <div className="details-section__image-wrap">
          <a href="https://www.google.com/maps/search/?api=1&query=Google&query_place_id=ChIJR3Na8pd53YgRk3pe5XujKqs" target="_blank" rel="noopener noreferrer">
             <iframe 
                src="https://maps.google.com/maps?q=Champions+Gate,+FL&t=&z=13&ie=UTF8&iwloc=&output=embed" 
                width="100%" 
                height="350" 
...
export default function ChampionsGatePage() {
  return (
    <main>
      <Header />
      <HeroInternal />
      ...
      <ReviewsSection className="reviews reviews--white" city="Champions Gate" />
      <CTASection />
      <Footer />
    </main>
  );
