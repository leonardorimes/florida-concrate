  ...
  return (
    <section className="hero-internal" style={{ backgroundImage: "none", backgroundColor: "var(--teal)", overflow: "hidden" }}>
      ...
      <div className="hero-internal__content">
        <h1>Concrete Coating Services<br/>in Clermont &amp; Celebration, FL</h1>
        <p>Durable, slip-resistant coatings for homes in Clermont &amp; Celebration, installed by experienced local professionals you can trust.</p>
      </div>
    </section>
  );
}
      ...
      <div className="details-section__grid" style={{ maxWidth: "1200px", margin: "0 auto", gap: "60px", gridTemplateColumns: "1fr 1fr", alignItems: "center", display: "grid" }}>
        ...
        <div className="details-section__image-wrap">
          <a href="https://www.google.com/maps/search/?api=1&query=Google&query_place_id=ChIJswGnatF43YgR1YegTrFBtXo" target="_blank" rel="noopener noreferrer">
             <iframe 
                src="https://maps.google.com/maps?q=Celebration,+FL&t=&z=13&ie=UTF8&iwloc=&output=embed" 
                width="100%" 
                height="350" 
...
export default function ClermontCelebrationPage() {
  return (
    <main>
      <Header />
      <HeroInternal />
      ...
      <ReviewsSection className="reviews reviews--white" city="Clermont & Celebration" />
      <CTASection />
      <Footer />
    </main>
  );
